...
class InPassportRecognizer(PatternRecognizer):
    ...
    The supported visual format is one letter followed by seven digits.
    A standalone passport number has no public check digit. When a complete
    Indian TD3 machine-readable zone (MRZ) is supplied, this recognizer also
    validates the ICAO document-number check digit adjacent to the number.
